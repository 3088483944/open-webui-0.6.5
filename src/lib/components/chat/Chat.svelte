...
<div
	class="h-screen max-h-[100dvh] transition-width duration-200 ease-in-out flex w-full"
	id="chat-container"
>
	...
	<!-- Sidebar area (fixed 1/3 width) -->
    <div class="w-1/3 flex-none bg-gray-100 dark:bg-gray-800 p-4 overflow-y-auto border-l border-gray-200 dark:border-gray-700">
        <MapView />
    </div>
